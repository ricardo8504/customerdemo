...
public class JwtService {
    ...
    public JwtService(JwtServiceConfig jwtServiceConfig) {
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return buildToken(extraClaims, userDetails, jwtServiceConfig.getJwtExpiration());
    }

    public long getExpirationTime() {
        return jwtServiceConfig.getJwtExpiration();
    }
